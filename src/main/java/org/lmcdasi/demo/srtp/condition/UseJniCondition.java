...
public class UseJniCondition extends SpringBootCondition {
    @Override
    public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        if (useJni && !useBuiltinNative && !useJna) {
            return ConditionOutcome.match(STR."Matched '\{APPLICATION_USE_JNI}'");
        }
        return ConditionOutcome.noMatch(STR."Only '\{APPLICATION_USE_JNI}' is allowed.");
    }
}
